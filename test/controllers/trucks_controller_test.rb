...
class TrucksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create truck" do
    assert_difference('Truck.count') do
      post trucks_url, params: { truck: { Driver_Id: @truck.Driver_Id, Id: @truck.Id, Marca: @truck.Marca, Modelo: @truck.Modelo, Placa: @truck.Placa } }
    end
  ...
  test "should update truck" do
    patch truck_url(@truck), params: { truck: { Driver_Id: @truck.Driver_Id, Id: @truck.Id, Marca: @truck.Marca, Modelo: @truck.Modelo, Placa: @truck.Placa } }
