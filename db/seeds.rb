...
Naviera.create(Nombre: 'Marfret', Telefono: 'erhtrh', Correo: 'egreh', Direccion: 'rhwn', companies_id: 2)
...
Route.create(Nombre: 'Visa-Limon', Precio_Empresa: 600, Precio_Chofer: 230000, companies_id: 2)
